...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_form, tag: 'div', class: 'form-group', error_class: 'has-error' do |b|
    ...
    b.use :error, wrap_with: {tag: 'span', class: 'help-block alert alert-error'}
    b.use :hint, wrap_with: {tag: 'p', class: 'help-block alert alert-info'}
  end
  ...
  config.wrappers :horizontal_form, tag: 'div', class: 'form-group row', error_class: 'has-error' do |b|
    ...
    b.optional :min_max
    b.optional :readonly
    b.use :label, class: 'col-sm-4 control-label text-md-right'
  ...
  config.wrappers :vertical_input_group, tag: 'div', class: 'form-group', error_class: 'has-error' do |b|
    ...
    b.wrapper tag: 'div' do |ba|
      ...
      ba.use :error, wrap_with: {tag: 'span', class: 'help-block alert alert-error'}
      ba.use :hint, wrap_with: {tag: 'p', class: 'help-block alert alert-info'}
    end
  end
